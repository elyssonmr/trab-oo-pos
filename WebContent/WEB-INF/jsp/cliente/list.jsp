					...
					<c:forEach items="${clienteList}" var="cliente">
						<tr>
							...
							<td><a class="btn btn-warning"
								href='<c:url value="editar"><c:param name="id" value="${cliente.id}" /></c:url>'><i
									class="icon-edit"></i></a></td>
							<td><a href="#" class="btn btn-danger delete-btn"
								data-id="${cliente.id}"><i class="icon-remove"></i></a></td>
						</tr>
					</c:forEach>
				</c:when>
				<c:otherwise>
